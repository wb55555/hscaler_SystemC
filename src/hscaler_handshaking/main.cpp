...
int sc_main(int argc, char* argv[])
{
	...
	sc_signal<bool> scl_o_data_rdy_sig;
	...
	sc_signal<bool> scl_i_data_rdy_sig;
	...
	tb0.scl_o_data_rdy(scl_o_data_rdy_sig);
	...
	tb0.scl_i_data_rdy(scl_i_data_rdy_sig);
	...
	hscaler0.scl_o_data_rdy(scl_o_data_rdy_sig);
	...
	hscaler0.scl_i_data_rdy(scl_i_data_rdy_sig);
	...
	sc_trace(trace_file, scl_i_data_rdy_sig, "scl_i_data_rdy");
	...
	sc_trace(trace_file, scl_o_data_rdy_sig, "scl_o_data_rdy");
